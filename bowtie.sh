...
export BOWTIE2_INDEXES=/scratch/bjl31194/yaupon/references
bowtie2 -x JYEU.hipmer.GA-F-4_assembly -1 pqX.1.fq_trimmed.fq -2 pqX.2.fq_trimmed.fq -p 4 -S pqX.sam
