...
java -jar $EBROOTGATK/GenomeAnalysisTK.jar -T UnifiedGenotyper -R /scratch/bjl31194/yaupon/references/JYEU.hipmer.GA-F-4_assembly.fasta -I cohort1.sample_map -dcov 1000 -glm BOTH -o yaupon_cohort1_raw_SNPs.vcf
