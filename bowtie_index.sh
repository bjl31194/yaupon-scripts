...
#makes index files
gunzip JYEU.hipmer.GA-F-4_assembly.fasta.gz > JYEU.hipmer.GA-F-4_assembly.fasta
bowtie2-build JYEU.hipmer.GA-F-4_assembly.fasta JYEU.hipmer.GA-F-4_assembly
